    ...
    def show(self,ncx,ncy,ncz,actFood):        
        ...
        for x in range(ncx):
            for y in range(ncy):
                for z in range(ncz):
                    coord = [
                        (round(x * dimCX + z * (width + 20)),round(y * dimCY)),
                        (round((x+1) * dimCX + z * (width + 20)),round(y * dimCY)),
                        (round((x+1) * dimCX + z * (width + 20)),round((y+1) * dimCY)),
                        (round(x * dimCX + z * (width + 20)),round((y+1) * dimCY))
                    ]
